...
public class RoadMap {
	...
	public Vehicle getVehicle(String id) {return mapVehicles.get(id);}
	
	public Road getRoad(String id) {return mapRoads.get(id);}
	
	public Junction getJunction(String id) {return mapJunctions.get(id);}
