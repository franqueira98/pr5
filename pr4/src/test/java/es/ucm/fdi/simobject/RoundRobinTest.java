...
public class RoundRobinTest {
	...
	public void roundRobinTest() {
		...
		j1.avanza();
		j1.avanza();
		assertTrue("No espera 2 ciclos para cambiar el semáforo",v1.getRoad()!=r1 || v2.getRoad()!=r1);
		j1.avanza();
		j1.avanza();
		assertTrue("Mal cambio de semáforo",v1.getRoad()!=r2 | v2.getRoad()!=r2);
		r3.avanza();
		r3.avanza();
		j1.avanza();
		j1.avanza();
		assertTrue("Debería pasar un solo coche",c.getRoad()==r1|c1.getRoad()==r2);
