...
public class JunctionTest {
	...
	public void junctionTest() {
		...
		test.newVehicle(v2);
		test.avanza();
		assertTrue("El método avanza no funciona bien",v.getRoad()!=r2 || v1.getRoad()!=r1 || v2.getRoad()!=r1);
		test.avanza();
		assertTrue("El método avanza no funciona bien",v1.getRoad()!=r2 || v2.getRoad()!=r1);
		test=itinerary.get(2);
		test.newVehicle(v);
		test.newVehicle(v1);
		assertTrue("No hace que un vehículo llegue",!v.getArrived() || v1.getArrived());
	}
